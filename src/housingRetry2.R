...
SalePrice <- LMpred.test
output <- data.frame(Id, SalePrice)
write.csv(output, file = "housingSimple2LM_Corr1.csv", row.names = FALSE)
...
SalePrice <- GBMpred.test
output <- data.frame(Id, SalePrice)
write.csv(output, file = "housingSimple2GBM_Corr1.csv", row.names = FALSE)
...
# Fitting nrounds = 1000, max_depth = 3, eta = 0.02, gamma = 0, colsample_bytree = 0.7, min_child_weight = 4, subsample = 0.5 on full training set
# 0.06617386
...
SalePrice <- ENETpred.test
output <- data.frame(Id, SalePrice)
write.csv(output, file = "housingSimple2ENET_Corr1.csv", row.names = FALSE)
...
output <- data.frame(Id, SalePrice)
write.csv(output, file = "housingSimple2LM_GBM_ENET_XGBOOST1.csv", row.names = FALSE)
...
output <- data.frame(Id, SalePrice)
write.csv(output, file = "housingSimple2LM_GBM_BAYESGLM_XGBOOST1.csv", row.names = FALSE)
...
output <- data.frame(Id, SalePrice)
write.csv(output, file = "housingSimple2LM_GBM_ENET_XGBOOST_RIDGE_BAYESGLM_LARS_GLMNET_Corr1.csv", row.names = FALSE)
